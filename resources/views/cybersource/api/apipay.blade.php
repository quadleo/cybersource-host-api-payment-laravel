...
<body class="font-sans antialiased text-gray-600 min-h-full flex flex-col [overflow-anchor:none]">
    <div class="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
        <a href="#" class="text-2xl font-bold text-gray-800">CyberSource API Payment</a>
    ...
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        ...
        <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <div class="">
                ...
                <div class="relative">
                    <input type="text" id="email" name="email" value="binod.bhandary@nicasiabank.com"
                ...
                <div class="relative">
                    <input type="text" id="card-holder" name="card-holder" value="Binod Bhandary"
                ...
                <div class="flex">
                    ...
                    <input type="text" name="card-year" 
                        class="w-full rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" 
                        placeholder="YYYY" onChange=authsetup()/>
                ...
                <div class="flex flex-col sm:flex-row">
                    <div class="relative flex-shrink-0 sm:w-7/12">
                        <input type="text" id="billing-address" name="billing-address" value="Trade Tower"
                            class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <select type="text" name="billing-state" value="CA"
                        class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500">
                        <option value="State">State</option>
                    </select>
                    <input type="text" name="billing-zip" value="44600"
    ...
    <script >
        function authsetup()
        {   
            var cardNum=document.getElementById('card-no').value
